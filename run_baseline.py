...
# Prepare dataset
indptr, indices, x, y, num_features, num_classes, num_nodes, train_idx, valid_idx, test_idx = get_mmap_dataset(path=dataset_path, split_idx_path=split_idx_path, num_features=args.features)
...
print(args.dataset, num_features, args.model, args.compute_type)
